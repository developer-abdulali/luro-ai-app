...
import { ArrowUpIcon, Share2Icon, UserIcon } from "lucide-react";
  ...
  return (
    <div className="w-full p-4">
        ...
        <Container delay={0.2}>
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                -2 from last month
                <ArrowUpIcon className="ml-1 inline h-4 w-4 text-red-500" />
              </p>
            </CardContent>
          </Card>
        </Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full mt-8">
        ...
        {/* Recent Sales */}
        <Container delay={0.3} className="lg:col-span-1">
          <Card className="rounded-xl border h-full">
            <CardHeader>
                ...
                return (
                  <div key={index} className="flex items-center justify-between space-x-4">
                    <div className="flex items-center space-x-4 overflow-hidden">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-muted font-medium text-xs text-foreground shrink-0">
                        {initials}
                      </div>
